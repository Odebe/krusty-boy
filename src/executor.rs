use crate::cpu::Cpu;
use crate::registers::Flag::{C, H, N, Z};
...
pub fn exec_opcode(cpu: &mut Cpu) -> u8 {
    ...
    match opcode {
        ...
        0x03 => {
            ...
            let value = cpu.alu_inc16(cpu.reg.bc());
            cpu.reg.set_bc(value);
        ...
        0x09 => {
            ...
            let value = cpu.alu_add_u16(cpu.reg.hl(), cpu.reg.bc());
        ...
        0x0a => {
            ...
            let value = cpu.mmu.read_u8(cpu.reg.bc());
            cpu.reg.a = value;
        ...
        0x0b => {
            ...
            cpu.reg.set_bc(cpu.alu_dec16(cpu.reg.bc()));
        ...
        0x13 => {
            ...
            let value = cpu.alu_inc16(cpu.reg.de());
            cpu.reg.set_de(value);
        ...
        0x19 => {
            ...
            let value = cpu.alu_add_u16(cpu.reg.hl(), cpu.reg.de());
            cpu.reg.set_hl(value);
        ...
        0x1a => {
            ...
            let value = cpu.mmu.read_u8(cpu.reg.de());
            cpu.reg.a = value;
        ...
        0x1b => {
            ...
            cpu.reg.set_de(cpu.alu_dec16(cpu.reg.de()));
        ...
        0x23 => {
            ...
            let value = cpu.alu_inc16(cpu.reg.hl());
            cpu.reg.set_hl(value);
        ...
        0x29 => {
            ...
            let value = cpu.alu_add_u16(cpu.reg.hl(), cpu.reg.hl());
            cpu.reg.set_hl(value);
        ...
        0x2b => {
            ...
            cpu.reg.set_hl(cpu.alu_dec16(cpu.reg.hl()));
        ...
        0x33 => {
            ...
            let value = cpu.alu_inc16(cpu.sp);
            cpu.sp = value;
        ...
        0x39 => {
            ...
            let value = cpu.alu_add_u16(cpu.reg.hl(), cpu.sp);
            cpu.reg.set_hl(value);
        ...
        0x46 => {
            ...
            let value = cpu.mmu.read_u8(cpu.reg.hl());
            cpu.reg.b = value;
        ...
        0x86 => {
            ...
            cpu.reg.a = cpu.alu_add_u8(cpu.reg.a, cpu.mmu.read_u8(cpu.reg.hl()));
        ...
        0x8e => {
            ...
            cpu.reg.a = cpu.alu_adc(cpu.reg.a, cpu.mmu.read_u8(cpu.reg.hl()));
        ...
        0x96 => {
            ...
            cpu.reg.a = cpu.alu_sub(cpu.reg.a, cpu.mmu.read_u8(cpu.reg.hl()));
        ...
        0x98 => {
            ...
            cpu.reg.a = cpu.alu_sbc(cpu.reg.a);
        ...
        0xa6 => {
            ...
            cpu.a = cpu.alu_and(cpu.reg.a, cpu.mmu.read_u8(cpu.reg.hl()));
        ...
        0xae => {
            ...
            cpu.reg.a = cpu.alu_xor(cpu.reg.a, cpu.mmu.read_u8(cpu.reg.hl()));
        ...
        0xb6 => {
            ...
            cpu.reg.a = cpu.alu_or(cpu.reg.a, cpu.mmu.read_u8(cpu.reg.hl()));
        ...
        0xbe => {
            ...
            cpu.reg.a = cpu.alu_cp(cpu.reg.a, cpu.mmu.read_u8(cpu.reg.hl()));
        ...
        0xe8 => {
            ...
            let value = cpu.alu_add_u16(cpu.sp, cpu.read_d());
            cpu.sp = value;
        ...
        0xf2 => {
            ...
            let addr = 0xFF00 | u16::from(cpu.read_c());
            cpu.reg.a = cpu.mmu.read_u8(addr);
        ...
        0xfa => {
            ...
            let value = cpu.mmu.read_u8(cpu.read_nn());
            cpu.reg.a = value;
        ...
        0xcb => {
            ...
            match postfix {
                ...
                0x46 => {
                    ...
                    cpu.alu_bit(cpu.mmu.read_u8(cpu.reg.hl()), 0);
                ...
                0x4e => {
                    ...
                    cpu.alu_bit(cpu.mmu.read_u8(cpu.reg.hl()), 1);
                ...
                0x56 => {
                    ...
                    cpu.alu_bit(cpu.mmu.read_u8(cpu.reg.hl()), 2);
                ...
                0x5e => {
                    ...
                    cpu.alu_bit(cpu.mmu.read_u8(cpu.reg.hl()), 3);
                ...
                0x66 => {
                    ...
                    cpu.alu_bit(cpu.mmu.read_u8(cpu.reg.hl()), 4);
                ...
                0x6e => {
                    ...
                    cpu.alu_bit(cpu.mmu.read_u8(cpu.reg.hl()), 5);
                ...
                0x76 => {
                    ...
                    cpu.alu_bit(cpu.mmu.read_u8(cpu.reg.hl()), 6);
                ...
                0x7e => {
                    ...
                    cpu.alu_bit(cpu.mmu.read_u8(cpu.reg.hl()), 7);
